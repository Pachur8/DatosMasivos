...
<body>
    <nav class="navbar navbar-expand-lg">
	    ...
	    <a class="navbar-brand" href="artists.php">Artistas Destacados</a>
	        ...
	        <li class="nav-item">
                    <a class="nav-link active" href="Vincent_van_Gogh.php">Vincent van Gogh</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                $sql = "SELECT * FROM artistas WHERE id = 1"; // Reemplaza 1 con el ID del artista que deseas mostrar
