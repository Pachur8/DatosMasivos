    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <ul class="nav nav-tabs justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="Pablo_Picasso.php">Pablo Picasso</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                $sql = "SELECT * FROM artistas WHERE id = 4"; // Reemplaza 1 con el ID del artista que deseas mostrar
